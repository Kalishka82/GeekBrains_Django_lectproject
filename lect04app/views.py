...
from .forms import ManyFieldsForm, ManyFieldsFormWidget
...
def many_fields_form(request):
    ...
    return render(request, 'lect04app/many_fields_form.html', {'form': form})
...
def upload_image(request):
    if request.method == 'POST':
        ...
        form = ImageForm()
    return render(request, 'lect04app/upload_prod_image.html', {'form': form})
